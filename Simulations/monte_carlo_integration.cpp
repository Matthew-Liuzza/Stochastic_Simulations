...
// just a simple demonstration of monte_carlo integration
...
double monte_carlo_integration(const double a, const double b, const double N, double (*func)(double)) {
...
int main() {
    ...
    std::cout << monte_carlo_integration(a,b,N,&x_squared);
